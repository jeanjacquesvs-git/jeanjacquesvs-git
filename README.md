...
Coin Swap Search AI is a heuristic-based state-space search puzzle that rearranges colored coins into a goal configuration using valid slide and jump moves. Built with Java and recently in Python, this project demonstrates my ability to model problems as search spaces, design admissible heuristics, and implement priority-based search algorithms.
